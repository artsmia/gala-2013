   ...
   <div class="row">
   	...
   	<div class="sixcol">
         <div class="title_block">
            ...
            <h1 class="title_event">Summer Party</h1>
         </div>
...
<div id="info">
   <div class="row">
   	<div class="sixcol">
      	<h2>Summer Party Tickets</h2>  
         <div class="sixcol">
            <h4 class="underline">Summer Party Ticket</h4>
            <h6>$85 per person ($35 tax deductible)</h6>
            <ul>
               <li>Light bites</li>
               <li>Complimentary drink ticket (1)</li>
               <li>Live music</li>
            </ul>
         </div>
         <div class="sixcol last">
            <h4 class="underline">VIP Summer Party Ticket</h4>
            <h6>$175 per person ($85 tax deductible)
            <br />$1,500 for 10 ($650 tax deductible)</h6>
            <p>All individual ticket benefits, plus:</p>
            <ul>
